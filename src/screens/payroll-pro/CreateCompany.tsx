...
export default function CreateCompany() {
  ...
  const renderProgress = () => (
    <div className="flex items-center gap-3 mb-8 bg-slate-50 dark:bg-slate-900 border border-slate-200 dark:border-white/5 p-4 rounded-2xl shadow-sm">
        ...
        return (
          <div key={s} className="flex items-center gap-3 flex-1 last:flex-initial">
            <div className={`w-8 h-8 rounded-xl flex items-center justify-center text-xs font-bold transition-all flex-shrink-0 ${
              ...
              'bg-white dark:bg-slate-950 text-slate-400 dark:text-slate-600 border border-slate-200 dark:border-white/10'
            }`}>
  ...
  return (
    <div className="min-h-screen bg-white dark:bg-slate-950 text-slate-900 dark:text-slate-200 flex overflow-hidden transition-colors duration-300">
      ...
      <div className="flex-1 flex flex-col min-w-0 bg-white dark:bg-slate-950 transition-colors duration-300">
        ...
        {/* Global Structural Context Action Row */}
        <div className="bg-slate-50/70 dark:bg-slate-900/40 border-b border-slate-200 dark:border-white/5 px-4 md:px-6 py-3.5 flex items-center justify-between">
          <span className="text-xs font-bold text-slate-500 dark:text-slate-400 capitalize tracking-wide">
            Process Execution Step: <span className="text-sky-600 dark:text-sky-400 font-extrabold">{step}</span>
          </span>
          <button 
            onClick={() => navigate(-1)} 
        ...
        <main className="flex-1 p-4 md:p-6 overflow-y-auto scrollbar-hide flex justify-center">
          <div className="max-w-xl w-full mx-auto">
            ...
            {step === 'info' && (
              <div className="animate-slide-up space-y-5">
                <div className="border-b border-slate-100 dark:border-white/5 pb-3">
                  <h2 className="text-base font-extrabold text-slate-900 dark:text-slate-100">Company Information</h2>
                  <p className="text-xs text-slate-500 dark:text-slate-400 mt-0.5">Provide legally authenticated corporate profile markers.</p>
                </div>

                <div className="space-y-4">
                  <div>
                    <label className="text-xs font-bold text-slate-700 dark:text-slate-300 mb-1.5 block">Company Legal Identity Name</label>
                    <input 
                      type="text" 
                    ...
                    />
                    {errors.name && <p className="text-xs font-semibold text-rose-600 dark:text-rose-400 mt-1">{errors.name}</p>}
                  </div>

                  <div>
                    <label className="text-xs font-bold text-slate-700 dark:text-slate-300 mb-1.5 block">Corporate Affairs Commission (CAC) Number</label>
                    <input 
                      type="text" 
                      className="w-full bg-white dark:bg-slate-900 border border-slate-200 dark:border-white/10 rounded-xl px-3.5 py-2.5 text-sm text-slate-900 dark:text-slate-100 placeholder-slate-400 focus:outline-none focus:border-sky-500 transition-all shadow-sm" 
                    ...
                    />
                    {errors.cacNumber && <p className="text-xs font-semibold text-rose-600 dark:text-rose-400 mt-1">{errors.cacNumber}</p>}
                  </div>

                  <div>
                    <label className="text-xs font-bold text-slate-700 dark:text-slate-300 mb-1.5 block">Business Class Category</label>
                    <select 
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <div>
                      <label className="text-xs font-bold text-slate-700 dark:text-slate-300 mb-1.5 block">Official Operations Email Address</label>
                      <input 
                        type="email" 
                        className="w-full bg-white dark:bg-slate-900 border border-slate-200 dark:border-white/10 rounded-xl px-3.5 py-2.5 text-sm text-slate-900 dark:text-slate-100 placeholder-slate-400 focus:outline-none focus:border-sky-500 transition-all shadow-sm" 
                      ...
                      />
                      {errors.email && <p className="text-xs font-semibold text-rose-600 dark:text-rose-400 mt-1">{errors.email}</p>}
                    </div>
                    <div>
                      <label className="text-xs font-bold text-slate-700 dark:text-slate-300 mb-1.5 block">Official Secure Phone Line</label>
                      <input 
                        type="tel" 
                        className="w-full bg-white dark:bg-slate-900 border border-slate-200 dark:border-white/10 rounded-xl px-3.5 py-2.5 text-sm text-slate-900 dark:text-slate-100 placeholder-slate-400 focus:outline-none focus:border-sky-500 transition-all shadow-sm" 
                  ...
                  <div>
                    <label className="text-xs font-bold text-slate-700 dark:text-slate-300 mb-1.5 block">Physical Headquarter Address</label>
                    <textarea 
                      className="w-full bg-white dark:bg-slate-900 border border-slate-200 dark:border-white/10 rounded-xl px-3.5 py-2.5 text-sm text-slate-900 dark:text-slate-100 placeholder-slate-400 focus:outline-none focus:border-sky-500 transition-all min-h-[90px] resize-none shadow-sm" 
                  ...
                  <div className="grid grid-cols-3 gap-3">
                    <div>
                      <label className="text-[10px] font-bold text-slate-700 dark:text-slate-300 mb-1.5 block truncate">Staff Projection</label>
                      <input 
                        type="number" 
                        className="w-full bg-white dark:bg-slate-900 border border-slate-200 dark:border-white/10 rounded-xl px-3 py-2 text-sm text-slate-900 dark:text-slate-100 placeholder-slate-400 focus:outline-none focus:border-sky-500 transition-all shadow-sm" 
                        placeholder="50"
                    ...
                    <div>
                      <label className="text-[10px] font-bold text-slate-700 dark:text-slate-300 mb-1.5 block truncate">Branch Stations</label>
                      <input 
                        type="number" 
                        className="w-full bg-white dark:bg-slate-900 border border-slate-200 dark:border-white/10 rounded-xl px-3 py-2 text-sm text-slate-900 dark:text-slate-100 placeholder-slate-400 focus:outline-none focus:border-sky-500 transition-all shadow-sm" 
                        placeholder="3"
                    ...
                    <div>
                      <label className="text-[10px] font-bold text-slate-700 dark:text-slate-300 mb-1.5 block truncate">Est. Payroll (₦)</label>
                      <input 
                        type="number" 
                        className="w-full bg-white dark:bg-slate-900 border border-slate-200 dark:border-white/10 rounded-xl px-3 py-2 text-sm text-slate-900 dark:text-slate-100 placeholder-slate-400 focus:outline-none focus:border-sky-500 transition-all shadow-sm" 
            ...
            {step === 'review' && (
              <div className="animate-slide-up space-y-5">
                <div className="border-b border-slate-100 dark:border-white/5 pb-3">
                  <h2 className="text-base font-extrabold text-slate-900 dark:text-slate-100">Review Data Submission</h2>
                  <p className="text-xs text-slate-500 dark:text-slate-400 mt-0.5">Please check all operational parameters prior to system commit execution.</p>
                </div>
                ...
                <div className="bg-slate-50 dark:bg-slate-900 border border-slate-200 dark:border-white/5 rounded-2xl p-5 space-y-3.5 shadow-sm">
                  ...
                  <div className="border-t border-slate-200 dark:border-white/5 pt-3.5 grid grid-cols-3 gap-4">
                    <div>
                      <p className="text-[10px] font-bold text-slate-400 uppercase tracking-wider">Projected Staff</p>
                      <p className="text-sm font-bold text-slate-900 dark:text-slate-100 mt-0.5">{data.expectedEmployeeCount}</p>
                    </div>
                    <div>
                      <p className="text-[10px] font-bold text-slate-400 uppercase tracking-wider">Stations</p>
                      <p className="text-sm font-bold text-slate-900 dark:text-slate-100 mt-0.5">{data.expectedBranchCount}</p>
                    </div>
                    <div>
                      <p className="text-[10px] font-bold text-slate-400 uppercase tracking-wider">Est. Monthly Base</p>
                      <p className="text-sm font-bold text-sky-600 dark:text-sky-400 mt-0.5 truncate">₦{Number(data.expectedMonthlyPayroll).toLocaleString()}</p>
                    </div>
                  </div>
                </div>
                ...
                <div className="flex gap-3">
                  <button 
                    ...
                    className="flex-1 bg-slate-50 hover:bg-slate-100 text-slate-700 dark:bg-slate-900 dark:hover:bg-slate-800/80 dark:text-slate-300 font-bold py-3 px-4 rounded-xl text-sm border border-slate-200 dark:border-white/5 flex items-center justify-center gap-2 transition-all active:scale-95"
                  >
                  ...
                  <button 
                    ...
                    className="flex-1 bg-sky-500 hover:bg-sky-600 text-white font-bold py-3 px-4 rounded-xl text-sm flex items-center justify-center gap-2 transition-all active:scale-95 shadow-md shadow-sky-500/10 disabled:opacity-50"
                  >
   ...
   {/* ─── STEP 3: SUBMITTED SUCCESS SCREEN ─── */}
            {step === 'submitted' && (
              <div className="bg-slate-50 dark:bg-slate-900 border border-slate-200 dark:border-white/5 rounded-2xl p-8 text-center shadow-sm animate-pop-in max-w-md mx-auto mt-4">
                ...
                <h2 className="text-base font-extrabold text-slate-900 dark:text-slate-100 mb-1">Onboarding Credentials Transmitted</h2>
                <p className="text-xs text-slate-500 dark:text-slate-400 max-w-[320px] mx-auto leading-relaxed">
                  The verification file for <strong className="text-slate-800 dark:text-slate-200 font-bold">{submittedCompany}</strong> has entered processing pipelines.
                </p>
                ...
                <p className="text-[11px] text-slate-400 dark:text-slate-500 max-w-[280px] mx-auto leading-relaxed mb-6 border-t border-slate-200 dark:border-white/5 pt-4">
...
function ReviewRow({ label, value }: { label: string; value: string }) {
  return (
    <div className="flex justify-between items-start gap-4 py-2 border-b border-slate-100 dark:border-white/5 last:border-0 last:pb-0">
      <span className="text-xs font-medium text-slate-500 dark:text-slate-400">{label}</span>
      <span className="text-xs font-bold text-slate-900 dark:text-slate-100 text-right max-w-[65%] leading-relaxed">{value}</span>
    </div>
  );
}